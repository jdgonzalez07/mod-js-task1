...
function paintDOM(events) {
  ...
  const tagToUpdate = document.getElementById("items-cards-upcoming");
  ...
  <div class="card-body">
    ...
    <span class="price">Price:$${events[i].price}</span>
    <a href="./detail.html" class="btn-card"> Go somewhere</a>
  </div>
</div>
  `;
  }
